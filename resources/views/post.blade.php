        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form>
                        <div class="col-md-4">
                          <div class="form-group row">
                            ...
                            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="○○文字以内">
                          </div>
                        </div>
                    ...
                    <button class="btn btn-lg btn-primary float-right" data-toggle="modal" data-target="#exampleModal">送信</button>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <p class="h5">国内の林業が注目されている2021年。高知県の仁淀川流域は林業が盛んで、佐川町と仁淀川町では、それぞれ町の手厚い研修制度が整っています。
          ...
          <div class="text-right mr-2 mb-2">
            ...
            <button type="button" class="btn btn-outline-success" onclick="location.href='{{ route('thankyou') }}'">送信</button>
            </div>
         </div>
       </div>
      </div>
